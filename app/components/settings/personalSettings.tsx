                    ...
                    <div className="flex justify-between items-center">
                        <div className="flex items-center gap-3">
                            <button
                                ...
                                className={`relative inline-flex h-6 w-12 items-center rounded-full transition-colors duration-300 ${notifications ? 'bg-[var(--color-accent)]' : 'bg-[var(--color-muted)]'
                                    }`}
                            >
                                <span
                                    className={`inline-block w-5 h-5 rounded-full bg-white shadow-md transition-transform duration-300 transform ${notifications ? 'translate-x-6' : 'translate-x-0.5'
                                        }`}
                                />
                            </button>
